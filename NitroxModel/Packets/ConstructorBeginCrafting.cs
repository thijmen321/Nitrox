...
namespace NitroxModel.Packets
{
    ...
    public class ConstructorBeginCrafting : Packet
    {
        ...
        public List<InteractiveChildObjectIdentifier> InteractiveChildIdentifiers { get; } = new List<InteractiveChildObjectIdentifier>();
        public Vector3 Position { get; }
        public Quaternion Rotation { get; }
        public string Name { get; }
        public Vector3[] HSB { get; } = new Vector3[0];
        public Vector3[] Colours { get; } = new Vector3[0];
